---
title: How to Make $15K Beating Sportsbooks and Casinos
---
...
- Understand math. Nothing fancy, but you need a solid grasp of arithmetic, including multiplication and percentages.
- No history of addiction or gambling issues. If you are prone to such issues, attempting to counter-gamble is more likely to harm you than help you.

Basic Principles

- Never put your money in anything you don't understand. Understand how each party in a transaction makes money and what their incentives are.
- Understand risk management. This mainly means reducing variance as much as possible (there will be a section dedicated to this topic). If you do not manage risk, there is a high likelihood you will lose money.
- Always calculate the expected value of a promotion before using it.
- Only bet when you have a positive expected value.
- Do not break the rules you have set in place for yourself.
- Stick to legal/regulated websites. Sketchy crypto websites can lure you in with good promotions, but then avoid paying you out. Not worth it!
...
**Note.** According to Ontario law, slots must have a minimum delay of 2.5 seconds between spins, and "auto-spin" features are not allowed. ([source](https://www.agco.ca/en/responsibilities-and-resources/game-design-and-features)) This is why slots is worse than mines in Ontario and serves as an example of regulation impacting what kind of stuff you should bet on.
...
- Stick to legal and regulated platforms to avoid getting scammed. The list of Ontario casinos is found on the [iGaming website](https://www.igamingontario.ca/en/operator/operators)
...
- Free bonuses, game credits, or deposit bonuses are obviously ideal as they carry minimal risk to profit
- You should calculate the EV of anything between a 1-10x wagering requirement to see if it's profitable
- In general, avoid anything with a larger than 10x wagering requirement since you're almost guaranteed to lose some/all of your money
